...
describe('calculator', function () {
  ...
  it("it can concatenate multiple number button clicks", function() {
    ...
    calculator.numberClick(9);
    assert.strictEqual(99, calculator.runningTotal);
  });
  ...
  it("it can chain multiple operations together", function() {
    ...
    calculator.operatorClick('=');
    assert.strictEqual(180, calculator.runningTotal);
  });
  // calculator.clearClick() - clear the running total without affecting the calculation
  it("it can clear the running total withour affecting the calculation", function() {
    calculator.numberClick(9);
    calculator.operatorClick('+');
    calculator.numberClick(9);
